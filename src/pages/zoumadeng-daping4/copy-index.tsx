          ...
          <div className="leval-one screen-one">
            ...
            <div className="screen-head">
              <div className="head-left">
                <img
                  src="http://j1.58cdn.com.cn/dist/jxt/static/images/exam-logo.png"
                  alt=""
                />
              </div>
              <div className="head-center">
                <div className="head-center-bac" />
            ...
            <div className="center-box">
              ...
              <div className="center-box-bottom">
                ...
                <div className="call-text-box">
                  <div className="call-long" />
                  <div className="call-duan" />
                </div>
